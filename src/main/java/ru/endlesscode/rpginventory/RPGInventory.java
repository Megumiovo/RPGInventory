...
import ru.endlesscode.rpginventory.database.MegumiTadokoro;
import ru.endlesscode.rpginventory.database.SQLManager;
...
public class RPGInventory extends JavaPlugin {
    ...
    public List<Player> lock = new ArrayList<>();
    ...
    public void onEnable() {
        ...
        mysql = Config.getConfig().getBoolean("MYSQL.Enable");
        if (mysql) {
